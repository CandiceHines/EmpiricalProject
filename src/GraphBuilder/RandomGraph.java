...
* java GraphBuilder.RandomGraph v, e, m, f
...
*/
    public static void main(String[] args){
        if(args.length != 5){
            ...
            System.out.println("java GraphBuilder.RandomGraph v, e, min, max, f");
            ...
            System.out.println("f - path and file name for saving this graph");
                    System.out.println("Example: java GraphBuilder.RandomGraph 999 50 75 101 graph1.txt");
